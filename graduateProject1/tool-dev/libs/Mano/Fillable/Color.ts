...
class Color extends COLOR_NAME {
    ...
    public static HSLAToRGBA(color: HSLA): RGBA {
        let h = color.H;
        let s = color.S;
        let l = color.L;
    ...
    public static HWBAToRGBA(color: HWBA): RGBA {
    ...
    public static LABAToRGBA(color: LABA): RGBA {
        const l = color.L;
        const a = color.A;
        const b = color.B;
        ...
        // Convert XYZ to RGB
        const gammaCorrect = (value: number) => (value <= 0.0031308 ? 12.92 * value : 1.055 * value ** (1 / 2.4) - 0.055);
    ...
    public static LCHAToRGBA(color: LCHA): RGBA {
        const l = color.L;
        const c = color.C;
        const h = color.H;
        const alpha = color.Alpha;
    ...
    public static OKLABAToRGBA(color: OKLABA): RGBA {
        const l = color.L;
        const a = color.A;
        const b = color.B;
        const alpha = color.Alpha;
    ...
    public static OKLCHAToRGBA(color: OKLCHA): RGBA {
        const l = color.L;
        const c = color.C;
        const h = color.H
        const alpha = color.Alpha;
    ...
    public static RGBAToHSLA(color: RGBA): HSLA {
        const r = color.R / 255;
        const g = color.G / 255;
        const b = color.B / 255;
        const alpha = color.Alpha;
    ...
    public static RGBAToHWBA(color: RGBA): HWBA {
        const r = color.R / 255;
        const g = color.G / 255;
        const b = color.B / 255;
        const alpha = color.Alpha;
    ...
    public static RGBAToLABA(color: RGBA): LABA {
        const r = color.R / 255;
        const g = color.G / 255;
        const b = color.B / 255;
        const alpha = color.Alpha;
    ...
    public static RGBAToLCHA(color: RGBA): LCHA {
        const r = color.R / 255;
        const g = color.G / 255;
        const b = color.B / 255;
        const alpha = color.Alpha;
    ...
    public static RGBAToOKLABA(color: RGBA): OKLABA {
        const r = color.R / 255;
        const g = color.G / 255;
        const b = color.B / 255;
        const alpha = color.Alpha;
    ...
    public static RGBAToOKLCHA(color: RGBA): OKLCHA {
        const r = color.R / 255;
        const g = color.G / 255;
        const b = color.B / 255;
        const alpha = color.Alpha;
