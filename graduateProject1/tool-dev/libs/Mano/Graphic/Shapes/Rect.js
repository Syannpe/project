...
_Rect_instances = new WeakSet(), _Rect_setStyles = function _Rect_setStyles(crc) {
    ...
    if (this === null || this === void 0 ? void 0 : this.boxShadow) {
        crc.shadowBlur = ((_a = this.boxShadow) === null || _a === void 0 ? void 0 : _a.blur) || 0;
        crc.shadowColor = ((_c = (_b = this.boxShadow) === null || _b === void 0 ? void 0 : _b.color) === null || _c === void 0 ? void 0 : _c.toString()) || "rgb(0,0,0)";
        crc.shadowOffsetX = ((_d = this.boxShadow) === null || _d === void 0 ? void 0 : _d.offsetX) || 0;
        crc.shadowOffsetY = ((_e = this.boxShadow) === null || _e === void 0 ? void 0 : _e.offsetY) || 0;
    }
    if (this === null || this === void 0 ? void 0 : this.border) {
        crc.lineCap = ((_f = this.border) === null || _f === void 0 ? void 0 : _f.lineCap) || "square";
        crc.lineDashOffset = ((_g = this.border) === null || _g === void 0 ? void 0 : _g.lineDash) || 10;
        crc.lineJoin = ((_h = this.border) === null || _h === void 0 ? void 0 : _h.lineJoin) || "bevel";
        crc.lineWidth = ((_j = this.border) === null || _j === void 0 ? void 0 : _j.lineWidth) || 1;
    }
